...
def tela_cadastro():   
    ...
    tela_cadastro = sg.Window('Cadastro', layout, background_color='SlateBlue', element_justification='c', size = (520, 420), return_keyboard_events=True)
...
def tela_login():
    ...
    tela_login = sg.Window('Login', layout, background_color='Slate Blue', element_justification='c', size=(300, 330), return_keyboard_events=True)
    ...
    while True:
        ...
        if evento == sg.WINDOW_CLOSED:
        ...
        elif evento == 'Entrar' or evento == 'KP_Enter:104' or evento == 'Return:36':
            validacao = 0
            ...
            if email_Login and senha_Login:
                ...
                if senha_Valida:
                    ...
                    sg.popup('Senha Incorreta!', 'Por favor, digite-a novamente.', background_color='Slate Blue')
...
def tela_alterar(matriz, Id_User):
    ...
    while True:
        ...
        if evento == sg.WINDOW_CLOSED:
            ...
            sg.popup_auto_close('Operação bem-sucedida', 'Valor alterado com sucesso! ', background_color='Slate Blue', text_color='Black', font='Arial 12')
